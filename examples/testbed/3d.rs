...
fn main() {
    ...
    app.add_systems(OnEnter(Scene::Light), light::setup)
        ...
        .add_systems(
            OnEnter(Scene::WhiteFurnaceSolari),
            white_furnace_solari::setup,
        )
...
impl Next for Scene {
    fn next(&self) -> Self {
        match self {
            ...
            Scene::WhiteFurnaceEnvironmentMapLight => Scene::WhiteFurnaceSolari,
            Scene::WhiteFurnaceSolari => Scene::Light,
        }
    }
}
...
mod white_furnace_solari {
    ...
    const CURRENT_SCENE: super::Scene = super::Scene::WhiteFurnaceSolari;
    ...
    pub fn setup(
        ...
        use bevy::{
            ...
            solari::prelude::{RaytracingMesh3d, SolariLighting},
        };
        ...
        commands.spawn((
            ...
            Hdr,
            Tonemapping::None,
            // Required for Solari and keeps anti-aliasing/upscaling extras (including DLSS) disabled.
    ...
    pub fn setup(mut commands: Commands) {
        ...
        warn!(
            "WhiteFurnaceSolari scene requires the `bevy_solari` feature. Rebuild with `--features bevy_solari`."
        );
    }
}
